# Board of Stewards — Operating Rules
**Draft v1.0**

This document defines how the Board of Stewards operates in practice. It is intended to be readable, stable, and non-bureaucratic.

## 1) Composition
The Board has 7 seats:
- 3 elected by Users
- 3 elected by Workers
- 1 Mission Guardian

## 2) Meeting cadence
- Regular meetings: at least **every six monthly**
- Special meetings: called by the Chair, CEO, or any 2 Stewards
- Emergency meetings: may be called with shorter notice when safety, security, or solvency is at risk

## 3) Chair and facilitation
- The Board elects a Chair from among the elected Stewards (not the Guardian) for 1-year terms.
- The Chair sets agendas, ensures time discipline, and manages votes.
- The CEO attends meetings unless the Board is in executive session.

## 4) Quorum
Quorum requires at least 5 seated members present, including:
- at least 2 User Stewards, and
- at least 2 Worker Stewards.

## 5) Voting rules
### 5.1 Routine matters
Routine matters pass by simple majority of votes cast by seated members present.

### 5.2 Protected Matters
Protected Matters require:
...
The Board may enter executive session (without the CEO) to discuss:
...
A summary of executive session topics should be recorded without disclosing sensitive details.

## 7) Conflicts of interest and recusals
...
4) **People & Compensation Committee**
   - reviews compensation policy compliance, pay ratio calculations, and founder compensation recommendations

Committees make recommendations; the Board decides.

## 9) Compensation governance
- Founder compensation requires:
  - recommendation from the People & Compensation Committee
  - Board approval in executive session
  - Founder recusal recorded in the minutes
- Compensation Ratio Policy compliance is reviewed annually.
...
- a Compensation Ratio Report (ratio, methodology, and compliance confirmation)
