...
- Docs structure: https://github.com/techofourown/org-techofourown/blob/main/docs/README.md
- ADRs: `docs/decisions/`
- RFCs: `docs/rfcs/`
...
- hw-ourbox-mini — OurBox Mini hardware
- hw-ourbox-desk-32 — OurBox Desk 32 hardware
